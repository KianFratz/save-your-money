...
The on-device result must be recorded before claiming the two-APK update and state-preservation acceptance criteria are met. The signing-certificate fingerprint and credential-backup locations belong in a private record outside this repository.
